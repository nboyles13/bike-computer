...
public class SuspectInfo {
    ...
    public static String getTriggerText(int triggers) {
        ...
        addText(sb, "dead-end", triggers, 1);
        addText(sb, "dead-start", triggers, 2);
        addText(sb, "node-block", triggers, 4);
        addText(sb, "bad-access", triggers, 8);
        addText(sb, "unkown-access", triggers, 16);
        addText(sb, "sharp-exit", triggers, 32);
        addText(sb, "sharp-entry", triggers, 64);
        addText(sb, "sharp-link", triggers, 128);
        addText(sb, "bad-tr", triggers, 256);
        return sb.toString();
    }
