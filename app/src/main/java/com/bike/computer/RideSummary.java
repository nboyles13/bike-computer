...
public final /* data */ class RideSummary {
    private final double ascentM;
    private final float avgMps;
    private final double distanceM;
    private final String gpx;
    private final int hrAvg;
    private final int hrMax;
    private final float maxMps;
    private final long movingMs;
    private final String name;
    private final int powerAvg;
    ...
    public /* synthetic */ RideSummary(long j, String str, double d, long j2, float f, float f2, int i, int i2, double d2, int i3, int i4, String str2, boolean z, String str3, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(j, str, d, j2, f, f2, i, i2, d2, i3, i4, str2, z2, str4);
    }
